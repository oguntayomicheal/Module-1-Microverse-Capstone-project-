...
const moreScientist = document.querySelector('.featured-speakers__more');
const toggleMore = document.querySelector('#desk_scientist');

const moreSpeakers = () => {
    moreScientist.addEventListener('click', () => {
    toggleMore.classList.toggle('more');
  });
};
